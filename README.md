## OBS Scoreboard
Various web components built with the intention of displaying live scoreboards either from a Web UI or as an OBS script.
...
#### OBS Script
Script for [Open Broadcast Softare (OBS)](https://obsproject.com/) to retrieve scores in realtime and update a text source. See `obs-client` folder for details.
